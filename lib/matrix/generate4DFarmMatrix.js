...
function generate4DFarmMatrix({ buildLvls, gainMultiplier }) {
  ...
  writeDataFile(`farm-4d-gold-${gainMultiplier}x.csv`, goldCsv);
  writeDataFile(`farm-4d-roi-${gainMultiplier}x.csv`, roiCsv);
  writeDataFile(`farm-4d-cost-${gainMultiplier}x.csv`, costCsv);
}
